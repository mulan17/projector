//own map, where we want to add, get and delete

package hashtable

import "fmt"

const maxValues = 10 //треба знати що наш хеш влізає в слайс

//HashTable implements a map with strings keys and string values
type HashTable struct {
	values []*entry//slice рядків
